      ...
      <div className="mx-auto max-w-md space-y-6">
        ...
        <Card className="border border-slate-800 bg-slate-950/80">
          <CardContent className="space-y-4 p-6">
            ...
            {success && (
              <div className="rounded-lg border border-emerald-800/50 bg-emerald-950/20 p-3 text-sm text-emerald-300">
                {success}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full rounded-full bg-violet-500 text-sm font-semibold text-white hover:bg-violet-400"
              >
                {loading
                  ? mode === 'signup'
                    ? 'Creating account...'
